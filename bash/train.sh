...
python -m torch.distributed.run \
    ...
    custom_vision.py \
    --base configs/custom_train_wrapper2_lora_reg_loracustom_atten_init_onlylora_ffn_basic_video2_visual.yaml \
    -t --gpus 0,1,2,3 \
    --lora True \
    ...
    --name "Hina_Amano-wrapper-person-ours"
...
python -m torch.distributed.run \
    ...
    --freeze_model "crossattn" \
    --base_learning_rate 0.00003 \
    --name "Tezuka_Kunimitsu-wrapper-person-ours"