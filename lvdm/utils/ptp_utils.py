...
def register_attention_control(model, controller):
    def ca_forward(self, place_in_unet):
        ...
        def forward(x, context=None, mask=None):
            ...
            if context is not None:
                ...
                is_cross = False
            # print(is_cross)
            context = context if is_cross else default(context, x)
    ...
    cross_att_count = 0
    for net in model.model.diffusion_model.named_children():
        if "input" in net[0]:
        ...
        # elif "init" in net[0]:
        #     cross_att_count += register_recr(net[1], 0, "init")
        # if "middle" in net[0]:
        #     cross_att_count += register_recr(net[1], 0, "mid")
...
class AttentionStore(AttentionControl):
    @staticmethod
    def get_empty_store():
        return {"down_cross": [], "mid_cross": [], "up_cross": [], "init_cross":[], "down_self": [], "mid_self": [], "up_self": [], "init_self":[]}
...
class AttentionControlEdit(AttentionStore, abc.ABC):
    ...
    def __init__(
        ...
        # print(self.cross_replace_alpha)
        # np.save('cross_replace_alpha.npy',self.cross_replace_alpha.cpu().numpy())
