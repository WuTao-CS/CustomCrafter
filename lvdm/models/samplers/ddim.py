...
from lvdm.utils.ptp_utils import register_attention_control, AttentionReplace
...
class DDIMSampler(object):
    ...
    def make_schedule(self, ddim_num_steps, ddim_discretize="uniform", ddim_eta=0., verbose=True):
        ...
        self.use_scale = False # self.model.use_scale
    ...
    def sample(self,
        ...
        if controller is not None:
            samples, intermediates = self.p2p_ddim_sampling(conditioning, size,
                                                    callback=callback,
    ...
    def ddim_sampling(self, cond, shape,
        ...
        for i, step in enumerate(iterator):
            ...
            if mid_step is not None and i == mid_step:
                break
    ...
    def p2p_ddim_sampling(self, cond, shape,
                      x_T=None, ddim_use_original_steps=False,
                      callback=None, timesteps=None, quantize_denoised=False,
                      mask=None, x0=None, img_callback=None, log_every_t=100,
                      temperature=1., noise_dropout=0., score_corrector=None, corrector_kwargs=None,
